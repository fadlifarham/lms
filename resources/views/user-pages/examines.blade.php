...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style="font-size: 10pt;">
            ...
            <li class="breadcrumb-item active" aria-current="page">Examines</li>
        </ol>
    </nav>
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 id="counter_question" class="m-0 font-weight-bold text-primary text-center">Examines</h6>
      </div>
      <div class="card-body">    
            <div id="question" class="form-group">
                ...
                <form>
                        <div class="checkbox">
                          <label><input type="checkbox" value="" class="checkbox"> Option 1</label>
                        </div>
                        <div class="checkbox">
                          <label><input type="checkbox" value="" class="checkbox"> Option 2</label>
                        </div>
                        <div class="checkbox disabled">
                          <label><input type="checkbox" value="" class="checkbox"> Option 3</label>
                        </div>
                </form>
