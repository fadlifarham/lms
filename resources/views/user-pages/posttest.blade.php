    ...
    <div class="card shadow mb-4 question-card" id="scroll">
        ...
        <div class="card-header py-3">
            ...
            <div id="custom_steps_button" class="float-right">
              <br><br>
              <button type="button" id="reportConfigStepsPrev" class="btn btn-sm btn-primary pdbtn">
                ...
                <p style="font-size: 14pt;">
                  @if($item->picture != NULL)
                    <div class="text-center">
                      <img id="problem_picture" class="problem_picture" alt="." src="{{ $item->picture }}">
                    </div>
                  @endif
                  <br>{{ $item->problem }}
                </p>
...
<script>
    $(document).ready(function() {
      ...
      var end = new Date();
      end.setHours(end.getHours() + {{ HelperController::waktuLatihan()[0] }});
      end.setMinutes(end.getMinutes() + {{ HelperController::waktuLatihan()[1] }});
      ...
      $(".choose").click(function() {
        ...
        // $("#wizard-t-" + indexStep).css("background", "#53d2fc");
